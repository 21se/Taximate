...
- Переместить папку "lib" в корневую папку игры
- Переместить файл скрипта "taximate.lua" в корневую папку игры
- Переместить папку "rsc" в корневую папку игры (не обязательно)
